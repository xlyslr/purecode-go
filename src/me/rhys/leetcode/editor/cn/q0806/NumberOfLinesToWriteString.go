...
//first line such that the total width does not exceed 100 pixels. Then, from where
//you stopped in s, continue writing as many letters as you can on the second
